...
public class MainServer extends JFrame {
	...
	// mainToServerBr = new BufferedReader(new
	// InputStreamReader(mainServerSocket.getInputStream()));
	// serverToMainBw = new BufferedWriter(new
	// OutputStreamWriter(mainServerSocket.getOutputStream()));
	//
	...
	//
	// Socket socketToServer = new Socket(InetAddress.getByName("127.0.0.1"),
	// portNum);
	//
	...
	// try {
	// serverToUserBr = new BufferedReader(new
	// InputStreamReader(serverSocket.getInputStream()));
	// userToServerBw = new BufferedWriter(new
